...
function drawHoldCursor() {
    ...
    contextC.font = "20px Oswald"
    contextC.fillStyle = "black";
    const textWidth = contextC.measureText("HOLD DOWN").width;
    contextC.fillText("HOLD DOWN", position.x - textWidth/2, position.y);
